...
var ChartBar = function (_React$Component) {
  _inherits(ChartBar, _React$Component);

  function ChartBar(props) {
    _classCallCheck(this, ChartBar);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChartBar).call(this, props));
  ...
  _createClass(ChartBar, [{
    ...
    value: function componentDidMount() {
      ...
      this.state.chr = new Chart(ctx, { type: 'bar', data: ChartData, options: GlobalOptions });
    }
  }, {
